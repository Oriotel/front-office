...
const Sidebar = memo(({ isOpen, onClose }) => {
  ...
  return (
    <nav className={cn(
      ...
      {/* Visual Indicator (Fleche) - Visible when hidden on desktop */}
      ...
      {/* Invisible trigger padding to make it easier to hover on desktop */}
      <div className="absolute top-0 -right-8 w-8 h-full hidden lg:block" />
